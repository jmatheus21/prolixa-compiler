...
public final class AAAtrConstADeclaracao extends PADeclaracao
{
    private PAExp _aExp_;

    public AAAtrConstADeclaracao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAAtrConstADeclaracao(
    ...
    {
        ((Analysis) sw).caseAAAtrConstADeclaracao(this);
    }
