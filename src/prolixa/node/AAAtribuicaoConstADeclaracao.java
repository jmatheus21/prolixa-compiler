...
public final class AAAtribuicaoConstADeclaracao extends PADeclaracao
{
    private PAExp _aExp_;

    public AAAtribuicaoConstADeclaracao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAAtribuicaoConstADeclaracao(
    ...
    {
        ((Analysis) sw).caseAAAtribuicaoConstADeclaracao(this);
    }
