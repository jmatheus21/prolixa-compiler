...
public final class AAExpVirgulaAComando extends PAComando
{
    private PAExp _aExp_;

    public AAExpVirgulaAComando()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAExpVirgulaAComando(
    ...
    {
        ((Analysis) sw).caseAAExpVirgulaAComando(this);
    }
